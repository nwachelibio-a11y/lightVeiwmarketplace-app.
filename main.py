    ...
    <body class="min-h-screen flex flex-col p-4 max-w-md mx-auto select-none justify-between">
        ...
        <main class="flex-1 flex flex-col justify-center my-6">
                ...
                <div id="pic-ad-banner" class="hidden bg-zinc-900 border border-orange-900/50 rounded-xl p-3 flex items-center justify-between text-left mb-2">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[9px] text-zinc-400">You spent time browsing! (Pic ad running)</p>
                        </div>
                    </div>
            ...
            <div id="view-detail" class="hidden space-y-4 w-full">
                ...
                <div class="zinc-card rounded-xl overflow-hidden shadow-xl">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <button onclick="triggerChatSecurityAdLoop()" class="w-full bg-orange-600 text-white text-xs font-bold py-3 rounded-lg mt-2 uppercase tracking-wide">
            ...
            <div id="ad-player" class="hidden fixed inset-0 bg-black z-50 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p id="ad-count-tracker" class="text-[10px] text-zinc-600 mt-4 font-mono"></p>
            </div>
        ...
        <script>
            ...
            // Setup 10-minute banner trigger loop simulation
            setTimeout(() => {
                if(session.email) { document.getElementById('pic-ad-banner').classList.remove('hidden'); }
            }, 8000);
            ...
            function triggerChatSecurityAdLoop() {
                watchedAdsCount = 0;
                runAdPlayerInstance();
            }

            function runAdPlayerInstance() {
                const player = document.getElementById('ad-player');
                const timerText = document.getElementById('ad-timer');
                const tracker = document.getElementById('ad-count-tracker');
                const title = document.getElementById('ad-title-display');
                
                let adTitles = ["Premium Crypto App", "Luxury Car Rental Ad", "Real Estate Investment Token"];
                title.innerText = adTitles[watchedAdsCount];
                
                player.classList.remove('hidden');
                let count = 3; 
                timerText.innerText = count;
                tracker.innerText = `Verified: ${watchedAdsCount} of 3 Ads Checked`;
            ...
            function dismissPicAd() {
                const btn = document.querySelector('#pic-ad-banner button');
